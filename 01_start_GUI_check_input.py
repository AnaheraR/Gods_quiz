...
class ChooseRounds:
    ...
    def to_enter(self):
        ...
        if to_questions != "invalid":
            self.var_feedback.set("{} of rounds will now start".format(to_questions))
    ...
    def output_answer(self):
        ...
        if has_errors == "yes":
            ...
            self.round_entry.config(bg="#f8cecc")
...
class Quiz:
    ...
    def __init__(self, rounds_choice):
        ...
        rounds_heading = "Name? - Round 1 of {}".format(rounds_choice)
